...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>resources/notebook/js/datepicker/datepicker.css" type="text/css" cache="false" />
    <link rel="stylesheet" href="<%=basePath%>resources/notebook/js/slider/slider.css" type="text/css" cache="false" />
    
    <script src="resources/notebook/js/app.v2.js"></script>
    <!-- fuelux -->
    <script src="<%=basePath%>resources/notebook/js/fuelux/fuelux.js" cache="false"></script>
    <!-- datepicker -->
    <script src="<%=basePath%>resources/notebook/js/datepicker/bootstrap-datepicker.js" cache="false"></script>
    <!-- slider -->
