...
/**
 * Tb001xbId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class Tb001xbId implements java.io.Serializable {
	...
	/** full constructor */
	public Tb001xbId(String cph, String tbnf) {
		this.cph = cph;
		this.tbnf = tbnf;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Tb001xbId))
			return false;
		Tb001xbId castOther = (Tb001xbId) other;
