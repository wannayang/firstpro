...
/**
 * Tb001xb entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "tb001xb", catalog = "ygcx")
public class Tb001xb implements java.io.Serializable {

	// Fields

	private Tb001xbId id;
	private String xbnx;
	private String jfrq;
	private String qbrq;
	private String zbrq;
	...
	/** minimal constructor */
	public Tb001xb(Tb001xbId id) {
		this.id = id;
	}

	/** full constructor */
	public Tb001xb(Tb001xbId id, String xbnx, String jfrq, String qbrq,
	...
	public Tb001xbId getId() {
		return this.id;
	}

	public void setId(Tb001xbId id) {
		this.id = id;
	}
